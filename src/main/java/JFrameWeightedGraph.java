...
public class JFrameWeightedGraph extends JFrame {
    ...
    public JFrameWeightedGraph(Map<Character, City> cities, double[][] adjacencyDistanceMatrix) {
        super("TSP City Graph Visualization - Undirected AND Weight Graph");
